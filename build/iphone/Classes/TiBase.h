...
// in simulator we redefine to format for mazaya Developer console
...
{\
	NSString * exceptionName = [@"org.mazaya." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.mazaya";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UImazayaNativeItemNone = -1, 
	UImazayaNativeItemSpinner = -2,
	UImazayaNativeItemProgressBar = -3,
	
	UImazayaNativeItemSlider = -4,
	UImazayaNativeItemSwitch = -5,
	UImazayaNativeItemMultiButton = -6,
	UImazayaNativeItemSegmented = -7,
	
	UImazayaNativeItemTextView = -8,
	UImazayaNativeItemTextField = -9,
	UImazayaNativeItemSearchBar = -10,
	
	UImazayaNativeItemPicker = -11,
	UImazayaNativeItemDatePicker = -12,
	
	UImazayaNativeItemInfoLight = -13,
	UImazayaNativeItemInfoDark = -14,
	
	UImazayaNativeItemDisclosure = -15,
	
	UImazayaNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all mazaya instances of
